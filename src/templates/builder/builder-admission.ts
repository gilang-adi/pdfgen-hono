import type { AdmissionDetails } from "../../types/opd.js";

export const buildAdmissionInfo = (data: AdmissionDetails) => {
  return {
      columns: [
        {
          alignment: 'left',
          ...
          table: {
            widths: ['auto', 'auto'],
            body: [
              [{ text: 'Admission No / MR', bold:true }, ': ' + data.admission_no],
              ...
              [{ text: 'Primary Doctor', bold:true }, ': ' + data.primary_doctor],
            ],
          },
        },
        {
